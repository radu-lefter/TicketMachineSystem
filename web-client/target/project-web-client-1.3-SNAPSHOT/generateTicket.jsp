...
<%
    ...
    */
    ...
    //getting purchasing hour
      ...
      String znDiffStr = Integer.toString(znDiff);
      ...
      totalPrice = Double.parseDouble(offpeakPPZ) + standardPrice * znDiff;
    }else if (purchased > bands.get(1) && purchased < bands.get(2)){
      totalPrice = Double.parseDouble(peakPPZ) + standardPrice * znDiff;
    ...
    try {
        ...
        Ticket ticket = gateManagementService.createTicket(znDiffStr, validFrom, validTo, strSt);
